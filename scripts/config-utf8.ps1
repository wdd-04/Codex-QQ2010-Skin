...
function Install-DreamSkinBaseTheme {
  ...
  try {
    ...
    $settings = [ordered]@{
      ...
      appearanceLightChromeTheme = 'appearanceLightChromeTheme = { accent = "#159FD8", contrast = 45, fonts = { code = "Cascadia Code", ui = "Microsoft YaHei UI" }, ink = "#28485B", opaqueWindows = true, semanticColors = { diffAdded = "#A9D99B", diffRemoved = "#F2A6A6", skill = "#2AA7D7" }, surface = "#F4FCFF" }'
    }
